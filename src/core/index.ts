...
declare global {
  namespace JSX {
    ...
    type TargetedAnimationEvent<Target extends EventTarget> = JSXInternal.TargetedAnimationEvent<Target>;
    type TargetedClipboardEvent<Target extends EventTarget> = JSXInternal.TargetedClipboardEvent<Target>;
    type TargetedCompositionEvent<Target extends EventTarget> = JSXInternal.TargetedCompositionEvent<Target>;
    ...
    type TargetedKeyboardEvent<Target extends EventTarget> = JSXInternal.TargetedKeyboardEvent<Target>;
    type TargetedMouseEvent<Target extends EventTarget> = JSXInternal.TargetedMouseEvent<Target>;
    type TargetedPointerEvent<Target extends EventTarget> = JSXInternal.TargetedPointerEvent<Target>;
    type TargetedTouchEvent<Target extends EventTarget> = JSXInternal.TargetedTouchEvent<Target>;
    type TargetedTransitionEvent<Target extends EventTarget> = JSXInternal.TargetedTransitionEvent<Target>;
    ...
    type AnimationEventHandler<Target extends EventTarget> = JSXInternal.AnimationEventHandler<Target>;
    type ClipboardEventHandler<Target extends EventTarget> = JSXInternal.ClipboardEventHandler<Target>;
    type CompositionEventHandler<Target extends EventTarget> = JSXInternal.CompositionEventHandler<Target>;
    ...
    type KeyboardEventHandler<Target extends EventTarget> = JSXInternal.KeyboardEventHandler<Target>;
    ...
    type TransitionEventHandler<Target extends EventTarget> = JSXInternal.TransitionEventHandler<Target>;
    ...
    type PictureInPictureEventHandler<Target extends EventTarget> = JSXInternal.PictureInPictureEventHandler<Target>;
  }
}
